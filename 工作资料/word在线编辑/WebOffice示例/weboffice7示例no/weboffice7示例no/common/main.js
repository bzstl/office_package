...
function SaveDoc(id) {
	try{
		...
		webObj.HttpAddPostString("name", "zhangshan");
		webObj.HttpAddPostCurrFile("uploadFile","bzs");		// 上传文件
		returnValue = webObj.HttpPost("http://192.168.201.193:8083/rx-rmip-corebiz-front/test2");	// 判断上传是否成功
			alert(returnValue);
